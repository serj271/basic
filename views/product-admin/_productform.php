...
<div class="product-update-category-form">
    ...
    <fieldset>
        ...
        <?= $form->field($productUpdatecategoryForm->product, 'created_at') ?>
        <?= $form->field($productUpdatecategoryForm->product, 'updated_at') ?>
        <?= $form->field($productUpdatecategoryForm->product, 'primary_photo_id') ?>
        <?= $form->field($productUpdatecategoryForm->product, 'id')->textInput(['value'=>$model->id,'readonly'=> true])?> 
    </fieldset>
